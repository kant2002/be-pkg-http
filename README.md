...
This repository contains the package with wrapper to make http requests.
...
In order to install and use the linked dependencies for `pkg-http` the following command can be used:
